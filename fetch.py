#!/usr/bin/env python3
"""
Recupero codici sconto Meafarma da shopilo.it
Sursa: https://shopilo.it/negozi/meafarma.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/meafarma.it"
STORE_NAME = "Meafarma"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Meafarma da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-meafarma)"
    }
    try:
